...
export const Testimonial = ({ large = false }) => {
  return (
    <div
      className={`vstack ${
        large
          ? ' w-[375px] h-auto rounded-3xl bg-gray'
    ...
    >
      <div className="vstack justify-center items-center  relative gap-2.5">
        <img
      ...
      >
        <div className="hstack items-start relative gap-3">
          {Array(5)
            .fill(0, 0, 5)
            .map((_v, i) => (
        ...
        <p className="hstack text-xs text-center text-primary">
